...
var _ = Describe("LogbookService", func() {
	...
	BeforeEach(func() {
		...
		logbookRequest = dto.LogbookRequest{
			...
			Style:               model.StyleY,
			Remarks:             utils.String("Remarks"),
			PersonalRemarks:     utils.String("Personal Remarks"),
			TotalBlockTime:      utils.TimeDuration(1 * time.Hour),
			PilotInCommandTime:  utils.TimeDuration(2 * time.Hour),
			SecondInCommandTime: utils.TimeDuration(3 * time.Hour),
			DualReceivedTime:    utils.TimeDuration(4 * time.Hour),
			DualGivenTime:       utils.TimeDuration(5 * time.Hour),
			MultiPilotTime:      utils.TimeDuration(6 * time.Hour),
			NightTime:           utils.TimeDuration(7 * time.Hour),
			IFRTime:             utils.TimeDuration(8 * time.Hour),
			IFRActualTime:       utils.TimeDuration(9 * time.Hour),
			IFRSimulatedTime:    utils.TimeDuration(10 * time.Hour),
			CrossCountryTime:    utils.TimeDuration(11 * time.Hour),
			SimulatorTime:       utils.TimeDuration(12 * time.Hour),
			...
			Passengers: []dto.PassengerEntry{
				...
				},
				{
					...
					Company:      utils.String("Company"),
					Phone:        utils.String("1234567890"),
					EmailAddress: utils.String("testing@test.com"),
					Note:         utils.String("Note"),
				},
			},
			Landings: []dto.LandingEntry{
				{
					...
					Count:        utils.Uint(1),
					NightCount:   utils.Uint(2),
					DayCount:     utils.Uint(3),
					AirportCode:  utils.String("SFO"),
				},
				{
					ApproachType: model.ApproachTypeVisual,
					Count:        utils.Uint(4),
					NightCount:   utils.Uint(5),
					DayCount:     utils.Uint(6),
					AirportCode:  utils.String("LAX"),
				},
			},
		}
		mockFlight = model.Flight{
		...
		mockFlightBeforeUpdate = model.Flight{
			...
			LandingAirportCode:  "LAX",
			Style:               model.StyleY,
			Remarks:             utils.String("MRemarks"),
			PersonalRemarks:     utils.String("Personal Remarks"),
			TotalBlockTime:      utils.TimeDuration(6 * time.Hour),
			PilotInCommandTime:  utils.TimeDuration(2 * time.Hour),
			SecondInCommandTime: utils.TimeDuration(155 * time.Hour),
			DualReceivedTime:    utils.TimeDuration(3 * time.Hour),
			DualGivenTime:       utils.TimeDuration(3 * time.Hour),
			MultiPilotTime:      utils.TimeDuration(2 * time.Hour),
			NightTime:           utils.TimeDuration(5 * time.Hour),
			IFRTime:             utils.TimeDuration(7 * time.Hour),
			IFRActualTime:       utils.TimeDuration(1 * time.Hour),
			IFRSimulatedTime:    utils.TimeDuration(10 * time.Hour),
			CrossCountryTime:    utils.TimeDuration(11 * time.Hour),
			SimulatorTime:       utils.TimeDuration(6 * time.Hour),
			SignatureURL:        utils.String("https://signature.com"),
		}
				...
				mockFlightArr := []model.Flight{
					{
						...
						Style:               "S1",
						Remarks:             utils.String("R1"),
						PersonalRemarks:     utils.String("PR1"),
						TotalBlockTime:      utils.TimeDuration(1),
						PilotInCommandTime:  utils.TimeDuration(1),
						SecondInCommandTime: utils.TimeDuration(1),
						DualReceivedTime:    utils.TimeDuration(1),
						DualGivenTime:       utils.TimeDuration(1),
						MultiPilotTime:      utils.TimeDuration(1),
						NightTime:           utils.TimeDuration(1),
						IFRTime:             utils.TimeDuration(1),
						IFRActualTime:       utils.TimeDuration(1),
						IFRSimulatedTime:    utils.TimeDuration(1),
						CrossCountryTime:    utils.TimeDuration(1),
						SimulatorTime:       utils.TimeDuration(1),
						SignatureURL:        utils.String("DUAL2"),
					},
					{
						...
						Remarks:             utils.String("R1"),
						PersonalRemarks:     utils.String("PR1"),
						TotalBlockTime:      utils.TimeDuration(2),
						PilotInCommandTime:  utils.TimeDuration(1),
						SecondInCommandTime: utils.TimeDuration(3),
						DualReceivedTime:    utils.TimeDuration(3),
						DualGivenTime:       utils.TimeDuration(2),
						MultiPilotTime:      utils.TimeDuration(5),
						NightTime:           utils.TimeDuration(15),
						IFRTime:             utils.TimeDuration(1),
						IFRActualTime:       utils.TimeDuration(2),
						IFRSimulatedTime:    utils.TimeDuration(21),
						CrossCountryTime:    utils.TimeDuration(2),
						SimulatorTime:       utils.TimeDuration(2),
						SignatureURL:        utils.String("DUAL1"),
					},
				}
				...
				mockLandingArr := []model.Landing{
					{
						...
						ApproachType: model.ApproachTypeVisual,
						Count:        utils.Uint(1),
						NightCount:   utils.Uint(1),
						DayCount:     utils.Uint(4),
						AirportCode:  utils.String("L1"),
					},
					{
						Model:        gorm.Model{ID: 2},
						FlightID:     1,
