...
func EmptyTotals() SingleLogbookEntry {
	return SingleLogbookEntry{}
}
...
type PDFExporter struct {
	...
	totalPage     SingleLogbookEntry
	totalPrevious SingleLogbookEntry
	totalTime     SingleLogbookEntry
...
func NewPDFExporter(format, ownerName, licenseNumber, address,
	signature, signatureImage string, exportConfig ExportPDF) (*PDFExporter, error) {
